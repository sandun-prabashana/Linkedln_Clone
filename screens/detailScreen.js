...
import { View, Image, StyleSheet, Text, Dimensions, Button, Alert, TouchableOpacity, lable, ActivityIndicator   } from 'react-native';
        ...
        return (
            <View style={styles.container}>
              ...
              < ActivityIndicator style={styles.loading} color={'#0b66c3'} size="large"/>
                ...
                <Text style ={styles.txtStyle2}>See people, jobs, and news in your area</Text>
                ...
                <TouchableOpacity style ={styles.Continuebtn} onPress={()=>this.changeLocationScreen()}> 
                ...
                {renderIf(this.state.PhotoScreen)(   
                    <View style={{height:height}}>
                    <Text style ={styles.txtStyle4}>Adding a photo helps people recognize you</Text>
                    ...
                    <Image 
                        ...
                        style={{height: 150, width:150,alignSelf:'center',borderRadius:100}}/>
                    </View>
                    )}
                    ...
                    <TouchableOpacity style ={styles.Continuebtn} onPress={()=>this.getImageFromGallery()}> 
                    <Text style={styles.Continuebtntxt}>
                    Add a photo
                    </Text>
                    </TouchableOpacity >
                    ...
                    <TouchableOpacity style ={styles.Continuebtn} onPress={()=>this.uploadImage()}> 
                    <Text style={styles.Continuebtntxt}>
                    Ok
                    </Text>
                    </TouchableOpacity >
