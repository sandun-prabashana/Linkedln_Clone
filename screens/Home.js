...
GoogleSignin.configure({
  webClientId:
    '978992527612-idaq40sosncbftmi079fa1nlvdtms2hj.apps.googleusercontent.com',
});
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => joinNow(navigation)}>
        <Text style={styles.joinbtntxt}>Join now</Text>
      </TouchableOpacity>

      <TouchableOpacity
        style={styles.joinwithgooglebtn}
        onPress={() => onGoogleButtonPress()}>
        <View style={styles.googlelogoView}>
          <Image
            style={styles.googlelogo}
            source={require('../img/google-logo-9822.png')}
          />
          <Text style={styles.joinwithgooglebtntxt}>Join with Google</Text>
        </View>
      </TouchableOpacity>
